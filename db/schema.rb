...
ActiveRecord::Schema.define(version: 2020_02_17_222946) do
  ...
  create_table "room_category_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.bigint "room_id"
